...
export default function SonorPage() {
  ...
  const tldrItems = language === 'fr' ? [
    {
      label: 'Contexte',
      content: 'Hackathon Recoder l\'Habitat #2 (gagnant) → Incubation Matrice & Banque des Territoires (2020-2022)',
    },
    {
      label: 'Problème',
    ...
    {
      label: 'Solution',
      content: 'Plateforme SaaS 360° : cartographie open data, recommandations d\'actions publiques, engagement citoyen',
    },
    {
      label: 'Mon rôle',
    ...
    {
      label: 'Context',
      content: 'Recoder l\'Habitat #2 Hackathon (winner) → Incubation Matrice & Banque des Territoires (2020-2022)',
    },
    {
      label: 'Problem',
  ...
  const sidebarProps = language === 'fr' ? {
    ...
    <div className="overflow-x-hidden" role="main">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-20 pb-16 max-w-7xl">
        ...
        <div className="mb-8" id="hero">
          <CaseStudyHero
            title={language === 'fr' 
              ? "SONOR (2020-2022) : transformer l'open data en rues plus calmes"
              : "SONOR (2020-2022): transforming open data into quieter streets"
            }
