                ...
                <div className="grid md:grid-cols-2 gap-6 my-6">
                  <div className="p-6 bg-card rounded-xl border border-border shadow-sm">
                    ...
                    <ul className="space-y-3 text-foreground">
                      ...
                      <li>
                        Product Strategy Market research via Mews reports and sustainability studies User journey
                        mapping for F&B managers MVP scope definition for hackathon constraints Human-in-the-loop
                        philosophy by design Front-end design (Phase 2)
                      </li>
                    </ul>
                  </div>
                  <div className="p-6 bg-card rounded-xl border border-border shadow-sm">
            ...
            <Section id="solution" title="Solution: Ambient Agentic Experience" number="3">
              <div className="bg-gradient-to-r from-primary to-accent text-primary-foreground p-8 rounded-2xl border border-primary/20">
                <p className="text-lg leading-relaxed">
                  Conversational interface prototyping (Phase 2 plan)
                  <strong>conversational-first system with visual transparency</strong>. Phase 1 uses a dashboard for
                  rapid input and oversight, managers see predictions, confidence scores, and reasoning chains. Phase 2
                  adds natural language queries: <em>"How many servers do I need for Saturday XX/XX/XX dinner?"</em> The
