...
export const projects: Project[] = [
  ...
  // Agentic Hospitality
  {
    ...
    tagline_en: "AI agents for hospitality efficiency",
    tagline_fr: "Agents IA autonomes pour l'efficacité hôtelière",
    ...
    bullets_en: [
      ...
      "Tech Stack: Claude, Google Cloud, Qdrant, n8n, ElevenLabs",
    ],
    bullets_fr: [
