...
export const projects: Project[] = [
  ...
  // Agentic Evaluation
  {
    ...
    subtitle_en: "From single agents to agent ecosystems — how do we trust coordination?",
    subtitle_fr: "Des agents isolés aux écosystèmes — comment faire confiance à la coordination ?",
    ...
    longDescription_fr:
      "Un Agent d'Évaluation conçu comme Superviseur pour les systèmes multi-agents.",
    bullets_en: [
