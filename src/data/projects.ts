...
export const projects: Project[] = [
  ...
  // WTTJ
  {
    ...
    subtitle_en: "How might we increase senior-candidate conversion on WTTJ?",
  ...
  {
    id: "agents-eval",
    title_en: "Evaluating AI agents at scale",
    title_fr: "Évaluer les agents IA à grande échelle",
    subtitle_en: "How do we turn trust into an asset?",
    subtitle_fr: "Comment transformer la confiance en atout ?",
    image: "/img/samuel-arkwright-unsplash.jpg",
    tags_en: ["Agentic Experiences", "Evaluation"],
    ...
    bullets_fr: [
      "Cycle de vie structuré et tableau de bord",
      "Scoring automatique avec LLM-as-a-Judge",
      "Problèmes & recommandations capturés pour itération rapide",
      "Prêt à s'adapter à tout domaine (UX, qualité, robustesse)",
    ],
    hidden: true,
    ctaLabel_en: "Discover the case study!",
    ctaLabel_fr: "Découvrir l'étude de cas !",
  ...
  // Agentic Hospitality
  {
    ...
    tagline_en: "Building autonomous AI agents for hospitality efficiency",
    tagline_fr: "Construire des agents IA autonomes pour l'efficacité hôtelière",
    modalTitle_en: "Can we value agents to predict restaurant and hotel attendance?",
    modalTitle_fr: "Peut-on valoriser les agents pour prédire la fréquentation ?",
    ...
    bullets_fr: [
      ...
      "Prédictibilité de la fréquentation et du F&B, Gestion du personnel",
      "Construit pour le Hackathon Pioneers AILab @ Station F",
      "Stack technique : Mistral, Google Cloud, Qdrant, n8n, ElevenLabs",
    ],
