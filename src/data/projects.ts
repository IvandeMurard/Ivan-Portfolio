...
export const projects: Project[] = [
  ...
  // Agentic Hospitality
  {
    ...
    subtitle_en: "How can AI agents optimize hotel operations?",
    subtitle_fr: "Comment les agents IA peuvent-ils optimiser les opérations hôtelières ?",
    ...
    category: "agentic-experiences",
    workType: "side_project",
    kicker_en: "CASE STUDY – AGENTIC HOSPITALITY",
    kicker_fr: "ÉTUDE DE CAS – HOSPITALITÉ AGENTIQUE",
    tagline_en: "AI agents for operational efficiency",
    tagline_fr: "Agents IA pour l'efficacité opérationnelle",
