...
export const cvSideProjects: SideProjectItem[] = [
  {
    ...
    description_en: "Agentic AI concierge for boutique hotels: multi-agent RAG architecture, evaluation pipeline, built with Cursor + Qdrant + Claude + Supabase",
    description_fr: "Concierge IA agentique pour hôtels boutique : architecture multi-agent RAG, pipeline d'évaluation, construit avec Cursor + Qdrant + Claude + Supabase",
    year: "2025",
  },
  {
    title_en: "Hack The Crisis – Hackathon",
    title_fr: "Hack The Crisis – Hackathon",
    description_en: "Reached the final – Designed & pitched a crisis response tool in 48h during COVID-19",
    description_fr: "Finaliste – Conception & pitch d'un outil de réponse de crise en 48h pendant le COVID-19",
    year: "2020",
  },
  {
    title_en: "Recoder l'Habitat – Hackathon",
    title_fr: "Recoder l'Habitat – Hackathon",
    description_en: "1st prize – Sustainable housing innovation challenge",
    description_fr: "1er prix – Challenge d'innovation pour l'habitat durable",
    year: "2019",
  },
  {
